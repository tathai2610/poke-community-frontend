...
const PokemonCard: FC<Props> = ({ pokemon }) => {
  const href = `/pokedex/${encodeURIComponent(String(pokemon.name).toLowerCase())}`

  return (
    <Link href={href} className="block">
      <div className="rounded-xl border p-8 bg-white shadow-sm flex flex-col items-center text-center h-96 hover:shadow-md transition-shadow">
